...
<div class="row">
    ...
    <div class="table-responsive">
        <table class="table">
                ...
                <tr>
                    <th><?= __('Matrix') ?></th>
                    <td><?= h($student->matrix) ?></td>
                </tr>
                <tr>
                    <th><?= __('Faculty') ?></th>
                    <td><?= $student->hasValue('faculty') ? $this->Html->link($student->faculty->name, ['controller' => 'Faculties', 'action' => 'view', $student->faculty->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Program') ?></th>
                    <td><?= $student->hasValue('program') ? $this->Html->link($student->program->name, ['controller' => 'Programs', 'action' => 'view', $student->program->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Campus') ?></th>
                    <td><?= $student->hasValue('campus') ? $this->Html->link($student->campus->name, ['controller' => 'Campuses', 'action' => 'view', $student->campus->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Id') ?></th>
            ...
            <div class="card-body text-body-secondary">
                ...
                <?php if (!empty($student->exemptions)) : ?>
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($student->exemptions as $exemptions) : ?>
                        <tr>
