		...
		<div class="dropdown mx-3 mt-2">
			...
			<i class="fa-solid fa-bars text-primary"></i>
				...
				<div class="dropdown-menu dropdown-menu-end" aria-labelledby="orederStatistics">
							<li><?= $this->Html->link(__('Edit Campus'), ['action' => 'edit', $campus->id], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
				<li><?= $this->Form->postLink(__('Delete Campus'), ['action' => 'delete', $campus->id], ['confirm' => __('Are you sure you want to delete # {0}?', $campus->id), 'class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
				<li><hr class="dropdown-divider"></li>
				<li><?= $this->Html->link(__('List Campuses'), ['action' => 'index'], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
				<li><?= $this->Html->link(__('New Campus'), ['action' => 'add'], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
							</div>
		</div>
    </div>
</div>
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <div class="card-body text-body-secondary">
                ...
                <?php if (!empty($campus->exemptions)) : ?>
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($campus->exemptions as $exemptions) : ?>
                        <tr>
            ...
            <div class="card-body text-body-secondary">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <?php foreach ($campus->students as $students) : ?>
                        <tr>
                            <td><?= h($students->id) ?></td>
